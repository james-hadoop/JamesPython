...
url = "http://reg.cwikids.org/enroll/83A2F2FDCBAEC31D.html?cid=8F8B5B2F9982D018"
...
target=browser.find_element_by_xpath("//*[@id='zswybm']/a[1]")
txt=target.get


cid = target.get_attribute('cid')
