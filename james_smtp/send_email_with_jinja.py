...
def get_data():
    ...
    parametres = {
        'location': LOCATION,
        'key': 'a1ed32b28d2a41ba9733310689ce9c0e',  # 注册和风天气会给你一个KEY
        'lang': 'zh',
        'unit': 'm'
    }
...
############################设置一些附属表头参数#############################
msg['From'] = formataddr(["james", sender])
# msg['To']=formataddr(["赖德发",receiver1])
# msg['To']=formataddr(["开心果汁",receiver2])
msg['To'] = formataddr(["james", receiver3])

msg['Subject'] = Header(subject, 'utf-8')

###################################登陆邮箱发送##################################
username = 'jamesqjiang@163.com'

# 此处需要填写qq授权码
password = 'jamesqjiang'
